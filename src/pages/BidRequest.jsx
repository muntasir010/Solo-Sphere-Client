...
const BidRequest = () => {
    ...
    const handleStatus = async (id, prevStatus, status) => {
        if (prevStatus === status) return console.log('Sry vai hobenna hoga maro')
                                            ...
                                            <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                <div className='flex items-center gap-x-6'>
                                                    ...
                                                    <button
                                                        ...
                                                        className='text-xl disabled:cursor-not-allowed text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none'
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={bid.status === 'Complete'}
                                                        className='text-xl disabled:cursor-not-allowed text-gray-500 transition-colors duration-200   hover:text-yellow-500 focus:outline-none'
                                                    >
                                                        <MdDoNotDisturb />
                                                    </button>
                                                </div>
